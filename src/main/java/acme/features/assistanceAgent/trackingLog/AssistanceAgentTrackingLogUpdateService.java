...
public class AssistanceAgentTrackingLogUpdateService extends AbstractGuiService<AssistanceAgent, TrackingLog> {
	...
	public void authorise() {
		...
		authorised = trackingLog != null && !trackingLog.getIsPublished() && trackingLog.getClaim() != null && trackingLog.getClaim().getAgent() != null && super.getRequest().getPrincipal().hasRealm(trackingLog.getClaim().getAgent());
