...
@ValidBooking
@Table(indexes = {
	@Index(columnList = "locatorCode", unique = true), @Index(columnList = "draftMode"), @Index(columnList = "customer_id,draftMode"), @Index(columnList = "purchasedAt,customer_id,draftMode")
})
